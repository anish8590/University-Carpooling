        ...
        <form action="OfferARideController" onsubmit ="return checkCheckboxes();" align = "center" name="search_rides_form"><font  style = "font-family: avenir">
            ...
            <div class="form-group">
                <div id="ride_days_box" style="display:none">
                    <h3> Select Days </h3>
                    Sun <input type="checkbox" name="ride_days" id="Sunday" value="Sunday"/>
                    Mon <input type="checkbox" name="ride_days" id="Monday" value="Monday" />
                    Tue <input type="checkbox" name="ride_days" id="Tuesday" value="Tuesday" />
                    Wed <input type="checkbox" name="ride_days" id="Wednesday" value="Wednesday" />
                    Thu <input type="checkbox" name="ride_days" id="Thursday" value="Thursday" />
                </div>
            </div>
