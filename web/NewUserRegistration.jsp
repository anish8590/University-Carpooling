    ...
    <head>
        ...
        <script type ="text/javascript">
            function validate() {
                ...
                if (!(/@annauniv.edu\s*$/.test(email))) {
                    alert("You can only register with your ANNAUNIV account");
                    return false;
                }
                return true;
            }
                ...
                <div class ="col-10 col-md-8 col-lg-6">
                    <div class="px-2">
                        <form name = "registerform" action="RegisterController" method="post" class="justify-content-center">
                            ...
                            <div class ="container">
                                <p class="copyright">&copy; University Student Carpooling Platform by Team-AA.</p>  
                            </div>
                        </form>
                        <!-- Form end -->
                    </div>
