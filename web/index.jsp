    ...
    <head>
        ...
        <script type ="text/javascript">
            function validate() {
                ...
                if (!(/@annauniv.edu\s*$/.test(uname))) {
                    alert("Please enter a valid ANNAUNIV email ID");
                    return false;
                }
                return true;
            }
                    ...
                    <div class="px-2">
                        <div class="login-dark">
                            <form name = "loginform" action="LoginController" method="post" class="form justify-content-center">
                                <h1 class="card-title text-center">ANNA</h1>
                                ...
                                <div class ="container">
                                    <p class="copyright">&copy; ANNA by Team-AA.</p>
